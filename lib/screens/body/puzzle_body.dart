...
class PuzzleBody extends StatefulWidget {
  ...
  const PuzzleBody({super.key, required this.question,this.fromResult = false,
    this.results});
                                    ...
                                    return Container(
                                      ...
                                      child: DragTarget<String>(
                                        ...
                                        onAcceptWithDetails: (details) {
                                          var value = widget.question
                                              .dragChecker!.keys
                                              .elementAt(index);
                                          widget.question.dragChecker![value] =
                                          true;
                                          bool finished = true;
                                          // loop on keys
                                          // الغرض هنا اثبات عكس اللي فرضناه ان اليوزر خلص كل حاجه
                                          for (var element
                                          in widget.question.dragChecker!
                                              .keys) {
                                            if (widget.question
                                                .dragChecker![element] ==
                                                false) {
